                ...
                ? (
                  <>
                    {projects.map((project, i) => (
                      <section key={i} class="projects__card">
                        <img
                        ...
                        <a class="projects__site-link btn" href={project?.homepage} target="_blank" rel="noopener noreferrer">
                          <svg
                        ...
                        <a class="projects__source-link btn" href={project?.html_url} target="_blank" rel="noopener noreferrer">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            height="1.5rem"
                            viewBox="0 -960 960 960"
